...
async def handle_callbacks(callback: types.CallbackQuery):
    if callback.data == "about_features":
        ...
        await callback.message.edit_text(text, reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🛒 Купить на Ozon", url="https://www.ozon.ru/...")],
            [InlineKeyboardButton(text="🚀 Поехали далее", web_app=WebAppInfo(url=MINI_APP_URL))],
            [InlineKeyboardButton(text="◀️ В начало", callback_data="back_to_start")]
        ]))
        ...
        await callback.message.edit_text(text, reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="👤 Консультация с автором", url="https://t.me/artyom_grafov")],
            [InlineKeyboardButton(text="🎓 Тренинги", url="https://t.me/kanal_masterskaya")],
            [InlineKeyboardButton(text="◀️ В начало", callback_data="back_to_start")]
        ]))
        ...
        if '"action":"practice_completed"' in data:
            await message.answer(
                ...
                reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                    [InlineKeyboardButton(text="🔄 Вернуться в Мастерскую", web_app=WebAppInfo(url=MINI_APP_URL))]
                ])
            )
        else:
